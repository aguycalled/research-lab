...
class TestMultisig(unittest.TestCase):
    def test_1(self):
        ...
        self.assertEqual(MultiSig.verify(m,X,MultiSig.sign(m,x)),1)
    ...
    def test_2_bad(self):
        ...
        m = hash_to_scalar('test message')
        self.assertEqual(MultiSig.verify(m,X,MultiSig.sign(m,x)),0)
...
class TestRingCT2(unittest.TestCase):
    def test_keygen_one(self):
        pass
        
    def test_sub_one(self):
        pass
        
    def test_spend_one(self):
        pass
        
    def test_spendVer_one(self):
        pass
    
    def test_correctness_one(self):
        pass
        
    def test_bootleProve_one(self):
        pass
        
    def test_bootleVerify_one(self):
        pass
...
tests = [TestMultisig,TestMatrixCommit,TestProduct,TestRingCT2]
for test in tests:
